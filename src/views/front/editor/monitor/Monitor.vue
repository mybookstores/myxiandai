  ...
  <div class="monitor">
    <el-container>
      <el-header height="30px">
        ...
        >
          统计分析结果 -- {{ monitorPaper.title }}
        </div>
      </el-header>
      <el-divider></el-divider>
      <el-main>
        <div class="analyzeTables" :model="monitorPaper" style="margin-top: -20px;">
          ...
          >
            ...
            <el-tag style="color:rgb(37,124,115);margin-bottom:10px;margin-top:10px;float:left"
...
export default {
  ...
  async mounted() {
    ...
    // console.log("this.answeruuuuuuuuus")
    // console.log(res)
