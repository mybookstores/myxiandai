<template>
  ...
  >
    <div class="questionnaire-name">
      问卷名称：
      <el-input v-model="title" style="margin-top: 10px;"> </el-input>
    </div>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="success" @click="createPaper()" style="background-color: #725ae9;border: #725ae9;">确 定</el-button>
    </span>
  </el-dialog>
</template>
